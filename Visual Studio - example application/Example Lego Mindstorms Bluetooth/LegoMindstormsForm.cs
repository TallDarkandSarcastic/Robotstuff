...
namespace Example_Lego_Mindstorms_Bluetooth
{
    public partial class LegoMindstormsForm : Form
    {
        ...
        private void btStartD_Click(object sender, EventArgs e)
        {
            string id = "1";
            messenger.SendMessage("MESSAGE",id);
           

        }

        private void btStopD_Click(object sender, EventArgs e)
        {
            string id = "4";
            messenger.SendMessage("MESSAGE", id);
        ...
        private void btStartP_Click(object sender, EventArgs e)
        {
            string id = "6";
            messenger.SendMessage("MESSAGE", id);
